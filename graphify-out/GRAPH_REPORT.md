# Graph Report - HERO  (2026-05-09)

## Corpus Check
- 393 files · ~587,797 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1627 nodes · 2178 edges · 54 communities detected
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 355 edges (avg confidence: 0.8)
...
Cohesion: 0.03
Nodes (115): handleDelete(), handleSubmit(), addApprovalCommentAction(), applyApprovalDecision(), approveApprovalGroupAction(), bulkUserActionsAction(), cancelDraftSubmissionAction(), cloneFormTemplateVersionAction() (+107 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (71): AnalyticsPage(), AuditLogsPage(), handleSubmit(), handleToggleActive(), updateNavbarThemeAction(), buildTransportSettings(), getExistingPwaPushSettings(), getExistingSmtpSettings() (+63 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (57): assertOvertimeRequestCreationAccess(), buildDailySessionCode(), buildSplNumber(), canManageOvertimeRequestSettings(), endOfDay(), getAuthenticatedEmployeeContext(), getImportCsvText(), getOvertimeRequestLeaderPermission() (+49 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (43): ensureCargoManifestTables(), generateManifestNumber(), getCargoManifestById(), getCargoManifests(), importCargoManifestsAction(), manageCargoManifestAction(), parseItemsJson(), syncCargoMasterData() (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (38): testPwaPushSettingsAction(), getMobileNotificationCount(), getMobileNotifications(), getMobileNotificationSettings(), buildNotificationScope(), buildRecipientFilter(), clearNotifications(), getRecipientNotifications() (+30 more)
...
Cohesion: 0.08
Nodes (16): buildSchedule(), dateRangeDays(), dayFromDate(), daysInMonth(), defaultPositionOnSite(), isEmploymentPositionLabel(), isLeadershipPosition(), isWeekend() (+8 more)
...
Cohesion: 0.08
Nodes (20): MobileExecutivePage(), MobileGamificationPage(), GET(), MobileHsePage(), endOfMonth(), getMobileEmployeeContext(), getMobileExecutive(), getMobileGamification() (+12 more)
...
Cohesion: 0.13
Nodes (18): createNotificationDelivery(), dataUrlToFile(), getAuthenticatedEmployee(), normalizeCoordinate(), normalizeSyncText(), resolveEmergencyRecipients(), sendEmergencyAlerts(), submitEmergencyIncidentFromPayload() (+10 more)
...
- **Thin community `Community 43`** (6 nodes): `collect()`, `DraggableEmployee()`, `formatScopeType()`, `if()`, `toDateTimeLocalValue()`, `org-structure-builder.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (6 nodes): `attendance-real.ts`, `attendanceHours()`, `attendanceStatusLabel()`, `calculateAttendanceOvertime()`, `minutesFromTime()`, `normalizeAttendanceStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 61`** (4 nodes): `ActivityTemplateForm()`, `dedupeOptions()`, `getDurationLabel()`, `activity-template-form.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (4 nodes): `ChartAreaInteractive()`, `chart-area-interactive.tsx`, `use-mobile.ts`, `useIsMobile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (4 nodes): `createDraftFromApp()`, `createEmptyDraft()`, `PortalChitraSettingsPanel()`, `portal-chitra-settings-panel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (4 nodes): `formatAuditValue()`, `formatSeverity()`, `SecurityAuditLogTable()`, `security-audit-log-table.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `ensureHeroGovernanceSeedData()` connect `Community 1` to `Community 0`, `Community 13`, `Community 14`, `Community 6`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `Boolean()` connect `Community 2` to `Community 1`, `Community 4`, `Community 15`, `Community 7`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `String()` connect `Community 3` to `Community 2`, `Community 8`, `Community 9`, `Community 10`, `Community 14`, `Community 16`, `Community 17`, `Community 19`, `Community 20`?**
...
- **Are the 25 inferred relationships involving `String()` (e.g. with `generateManifestNumber()` and `POST()`) actually correct?**
