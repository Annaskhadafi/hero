...
## History
- 2026-06-24: Mobile Profile page load fix: removed extra Server Component auth/user lookup from page render and now derives displayed email from already-loaded User Management employee data to avoid production render crashes while keeping profile save sync logic.
