...
export const centralServiceForecastPeriods = pgTable('hero_central_service_forecast_periods', {
  id: serial('id').primaryKey(),
...
export const centralServiceForecastItems = pgTable(
  'hero_central_service_forecast_items',
  {
    ...
    osRemark: text('os_remark').notNull().default(''),
...
export const centralServiceForecastActuals = pgTable(
  'hero_central_service_forecast_actuals',
  {
    ...
    periodId: integer('period_id')
      .notNull()
      .references(() => centralServiceForecastPeriods.id, { onDelete: 'cascade' }),
    forecastItemId: integer('forecast_item_id').references(() => centralServiceForecastItems.id, {
      onDelete: 'set null',
    }), // Null if unplanned/takeout
