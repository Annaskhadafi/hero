...
export const activityLibraries = pgTable('hero_activity_libraries', {
  ...
  sectionId: integer('section_id'),
  sectionIds: jsonb('section_ids').$type<number[]>().default([]),
  ...
  requiresTireCount: boolean('requires_tire_count').notNull().default(false),
...
export const apdNotificationConfig = pgTable('hero_apd_notification_config', {
  ...
  recipientEmails: text('recipient_emails').notNull().default(''),
  ccEmails: text('cc_emails').notNull().default(''),
  serviceCcEmail: text('service_cc_email').notNull().default(''),
  repairCcEmail: text('repair_cc_email').notNull().default(''),
  teCcEmail: text('te_cc_email').notNull().default(''),
  serviceReminderEmail: text('service_reminder_email').notNull().default(''),
  repairReminderEmail: text('repair_reminder_email').notNull().default(''),
  teReminderEmail: text('te_reminder_email').notNull().default(''),
  isActive: boolean('is_active').notNull().default(true),
  updatedAt: timestamp('updated_at').notNull().defaultNow(),
})
