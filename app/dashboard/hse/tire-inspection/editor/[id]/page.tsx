...
import { TireInspectionEditorClient } from './client-page'
import { getInspectionDetail } from '../../actions'
import { getCurrentMenuPermission } from '@/lib/hero-access'
import { notFound, redirect } from 'next/navigation'

export default async function TireInspectionEditorPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <AdminPageShell
      ...
      description="Edit dan sesuaikan teks laporan AI sebelum diekspor."
    >
      <TireInspectionEditorClient detail={detail} />
    </AdminPageShell>
  )
}
