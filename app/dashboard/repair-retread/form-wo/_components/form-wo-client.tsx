          ...
          <div className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/70 p-4">
            ...
            {editItem ? (
              ...
              editItem.submitterSignatureUrl ? (
                <div className="flex flex-col justify-between gap-3 rounded-xl border border-slate-200 bg-slate-50/70 p-3.5 sm:flex-row sm:items-center">
                  <div className="flex min-w-0 items-center gap-3">
                    <div className="flex h-12 w-28 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white p-1 shadow-2xs">
                      <img
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-[11px] text-slate-500">
                        Dokumen ini telah ditandatangani oleh pemohon (
                        {editItem.pemohon || 'Pemohon'}). Team Billing tidak perlu menandatangani
                        ulang saat menerbitkan Nomor WO.
                      </p>
                    </div>
                  </div>
                  <span className="shrink-0 self-start rounded-full border border-emerald-300 bg-emerald-100/80 px-2.5 py-1 text-[10px] font-bold text-emerald-800 sm:self-center">
                    ✓ Terverifikasi
                  </span>
                </div>
              ) : null
              ...
              <div className="space-y-2.5 rounded-xl border border-slate-200 bg-slate-50/70 p-4">
                <div className="flex items-center justify-between">
                  ...
                  {profileSig && (
                    <Button
                      ...
                      className="h-6 px-2 text-[10px] font-semibold text-indigo-700 hover:bg-indigo-50 hover:text-indigo-800"
                    >
                ...
                {isUsingProfileSig && profileSig ? (
                  <div className="space-y-2">
                    <div className="relative flex min-h-[110px] flex-col items-center justify-center rounded-lg border-2 border-emerald-200 bg-emerald-50/40 p-3">
                      <span className="absolute top-2 right-2 inline-flex items-center gap-1 rounded-full border border-emerald-300 bg-emerald-100 px-2.5 py-0.5 text-[10px] font-bold text-emerald-800">
                      ...
                      <img
                        ...
                        className="my-1 max-h-20 object-contain"
                      />
                    </div>
                    <p className="text-center text-[11px] text-slate-500">
                      Tanda tangan dari profil akun Anda akan otomatis digunakan sebagai penanggung
                      jawab pengajuan.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-2">
                    ...
                    {submitterSignatureUrl && !isUsingProfileSig && (
                      <Button
                        ...
                        className="h-7 w-full border-indigo-200 text-xs font-semibold text-indigo-700 hover:bg-indigo-50"
                      >
                        {isSavingProfileSig ? (
                ...
                <Table className="w-full min-w-[1750px] text-xs">
                  ...
                  <TableBody className="divide-y divide-slate-100">
                      ...
                      <TableRow key={item.id} className="hover:bg-slate-50/60">
                        ...
                        <TableCell>
                          <Input
                            ...
                            placeholder="e.g. WO-CP-2024-001"
                            className="h-9 w-full border-slate-200 font-mono text-xs"
                          />
                        </TableCell>
                    ...
                    <TableRow className="border-t-2 border-slate-300 bg-yellow-300/90 font-bold text-slate-900">
                      <TableCell
                        colSpan={
                          repairItems.some((r) => isCiptaKridatamaCustomer(r.customer)) ? 8 : 7
                        }
                        className="py-2.5 text-center text-xs tracking-wider uppercase"
                      >
                        Total Amount
              ...
              <table className="w-full min-w-[1100px] border-collapse text-left text-xs">
                <thead>
                  <tr className="border-b border-slate-300 bg-slate-100 font-bold text-slate-800">
                    ...
                    <th className="border-r border-slate-300 px-3 py-2.5">Customer</th>
                    <th className="border-r border-slate-300 px-3 py-2.5">Site</th>
                    <th className="border-r border-slate-300 px-3 py-2.5">Tire Size</th>
                    <th className="border-r border-slate-300 px-3 py-2.5">SN Tire</th>
                    {(isCiptaKridatamaCustomer(item.customer) ||
                      repairItemsList.some((r) => isCiptaKridatamaCustomer(r.customer))) && (
                      <th className="border-r border-slate-300 px-3 py-2.5">ID Unit</th>
                    )}
                    <th className="border-r border-slate-300 px-3 py-2.5">Brand</th>
                    <th className="border-r border-slate-300 px-3 py-2.5">Cat. Injury</th>
                    <th className="border-r border-slate-300 px-3 py-2.5 text-right">Price</th>
                    <th className="border-r border-slate-300 px-3 py-2.5 text-center">WO CP</th>
                    <th className="border-r border-slate-300 px-3 py-2.5 text-center">Number PO</th>
                    <th className="border-r border-slate-300 px-3 py-2.5 text-center">Date PO</th>
                ...
                <tbody className="divide-y divide-slate-200">
                  {repairItemsList.map((row, idx) => (
                    <tr key={idx} className="hover:bg-slate-50">
                      ...
                      <td className="border-r border-slate-200 px-3 py-2">{row.brand || '-'}</td>
                      ...
                      <td className="px-3 py-2 text-center">{row.pos || '-'}</td>
                    </tr>
                  ))}
                      ...
                      >
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            >
                              <Button
                                ...
                                variant="ghost"
                                size="sm"
                                className="h-8 w-8 cursor-pointer rounded-lg p-0 text-slate-600 hover:text-emerald-600"
                                title="Download PDF"
                              >
                        ...
                        <TableCell className="px-4 py-3 text-xs whitespace-nowrap">
                          <div className="font-semibold text-slate-900">
                            {formatHari(item.tanggal || item.tanggalPengajuan, item.hari)}
                          </div>
                          <div className="font-mono text-[11px] text-slate-500">
                            {formatDate(item.tanggal || item.tanggalPengajuan)}
                          </div>
                        </TableCell>
                        ...
                        <TableCell className="px-4 py-3 font-mono text-xs whitespace-nowrap text-slate-600">
                                      ...
                                      <TableRow className="h-8">
                                        ...
                                        {item.jenisPengajuan === 'service' ? (
                                          ...
                                          <>
                                            ...
                                            {(isCiptaKridatamaCustomer(item.customer) ||
                                              parsedItems.some((sub: any) =>
                                                isCiptaKridatamaCustomer(sub.customer)
                                              )) && (
