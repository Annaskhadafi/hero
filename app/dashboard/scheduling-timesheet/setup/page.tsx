...
export default async function SchedulingTimesheetSetupPage() {
  ...
  return <SchedulingTimesheetWorkspace mode="setup" employees={options.employees} sites={options.sites} schedulingConfigs={options.schedulingConfigs} schedulingStatuses={options.schedulingStatuses} />;
}
