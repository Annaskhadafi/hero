...
const siteSchema = z.object({
  ...
  id: optionalPositiveIntField,
  name: z.string().trim().min(1).max(100),
  provinceId: z.string().trim().max(10).optional().default(""),
  provinceName: z.string().trim().max(150).optional().default(""),
  regencyId: z.string().trim().max(10).optional().default(""),
  regencyName: z.string().trim().max(150).optional().default(""),
  districtId: z.string().trim().max(10).optional().default(""),
  districtName: z.string().trim().max(150).optional().default(""),
  villageId: z.string().trim().max(10).optional().default(""),
  villageName: z.string().trim().max(150).optional().default(""),
