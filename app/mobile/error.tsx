...
export default function MobileError({
  ...
  return (
    <div className="mx-auto max-w-[430px] px-4 pt-8">
      <div className="space-y-4 rounded-[1.25rem] bg-white p-5 shadow-[0_14px_32px_rgba(8,32,51,0.08)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-black text-[#082033]">Gagal memuat halaman</h2>
            <p className="text-xs text-[#486275]">Terjadi kendala saat membuka halaman mobile.</p>
          </div>
        </div>
