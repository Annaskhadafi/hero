      ...
      <section className="rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-800 p-5 text-white">
        <div className="flex items-center gap-3">
          <Link
            ...
            aria-label="Kembali"
          >
            <ArrowLeft className="size-5 text-emerald-200" />
          </Link>
          <div>
            <p className="text-[11px] font-medium uppercase tracking-wider text-emerald-200">Form Pengajuan</p>
            <h1 className="mt-0.5 text-lg font-bold tracking-tight">Ajukan Request Tools</h1>
          </div>
        </div>
      </section>
