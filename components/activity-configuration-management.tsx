        ...
        {canEdit && (
          <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
            <DialogTrigger asChild>
              <Button type="button" onClick={openCreateModal} className="rounded-full shadow-sm cursor-pointer">
                  ...
                  <TableRow key={setting.id} className="hover:bg-muted/20 transition-colors">
                    ...
                    <TableCell className="align-top text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        {canEdit ? (
                          <Dialog open={editingItem?.id === setting.id} onOpenChange={(open) => !open && setEditingItem(null)}>
                            <DialogTrigger asChild>
                              <Button
                                size="sm"
                                variant="outline"
                                ...
                                className="h-8 rounded-lg px-2.5 text-xs cursor-pointer"
                              >
                        ...
                        {canDelete && (
                          <AlertDialog open={deletingItem?.id === setting.id} onOpenChange={(open) => !open && setDeletingItem(null)}>
                            <AlertDialogTrigger asChild>
                              <Button
                                ...
                                className="h-8 rounded-lg px-2.5 text-xs text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/40 hover:text-rose-700 border-rose-200 dark:border-rose-900 cursor-pointer"
                              >
