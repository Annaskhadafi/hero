  ...
  return (
    <div className="mobile-light-scope min-h-dvh bg-[#dfe8ef] text-[#082033]">
      <div className="mx-auto min-h-dvh max-w-[430px] bg-[#f6fbff] shadow-[0_24px_80px_rgba(8,32,51,0.18)]">
        ...
        <nav className="fixed inset-x-0 bottom-0 z-40 mx-auto max-w-[430px] bg-white/94 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2 shadow-[0_-18px_36px_rgba(8,32,51,0.08)] backdrop-blur-xl">
            ...
            {bottomNavItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  onClick={() => beginNavigation(item.href)}
                  className={cn(
                    "flex min-h-12 touch-manipulation flex-col items-center justify-center gap-1 rounded-lg px-1 text-[9px] font-black uppercase tracking-[0.02em] transition active:scale-[0.96]",
                    isActive
