...
const GROUPED_SECTIONS: Record<string, MenuSeed[]> = {
  ...
  "Human Capital": [
    ...
    { title: "RFR (Permohonan Rekrutmen)", url: "/dashboard/hc/rfr", section: "Human Capital", groupLabel: "Recruitment Management", iconName: "file-check", resource: "rfr", sortOrder: 9 },
