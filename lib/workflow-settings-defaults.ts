...
export const DEFAULT_DAILY_ACTIVITY_SETTINGS: DailyActivityWorkflowSettings = {
  approvalMatrix: {
    sectionHeads: [
      { section: 'Technical Support', name: 'Alfi', email: 'raihanaraya36@gmail.com' },
      { section: 'Workshop', name: 'Bagus', email: 'raihanaraya36@gmail.com' },
      { section: 'Training Support', name: 'Adit', email: 'raihanaraya36@gmail.com' },
      { section: 'SHE Support', name: 'Suhartono', email: 'raihanaraya36@gmail.com' },
      { section: 'Supply Chain Management', name: 'Aris', email: 'raihanaraya36@gmail.com' },
    ],
    managerName: 'Romy Hidayat',
    managerEmail: 'raihanaraya36@gmail.com',
    hrName: 'Kesuma Bagaskara',
    hrEmail: 'raihanaraya36@gmail.com',
