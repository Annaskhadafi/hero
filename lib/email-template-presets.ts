...
Tim Human Capital`,
  ...
  },
  {
    ...
    htmlContent: 'Yth. {{approverName}}, Pengajuan Work Order (Form WO) {{noPengajuan}} untuk customer {{customer}} ({{jobType}}) memerlukan persetujuan Anda.',
    ...
    sampleValues: {
      ...
      approvalLink: 'https://hero.chitraparatama.co.id/dashboard/repair-retread/form-wo',
    },
  },
  {
