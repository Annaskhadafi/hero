...
export const CS_FORECAST_IMPORT_FIELDS = [
  { key: "customer", label: "Customer", required: true, aliases: ["customer", "pelanggan", "nama customer"] },
  { key: "picSales", label: "PIC Sales", required: true, aliases: ["pic sales", "pic", "sales"] },
  { key: "isProductAccessories", label: "Is Accessories", required: false, aliases: ["is_product_accessories", "accessories", "aksesoris"] },
  { key: "osInvoicePrevMonth", label: "O/S Prev Month (IDR)", required: false, aliases: ["os invoice", "os invoice prev month", "os"] },
  { key: "repairForecast", label: "Repair (IDR)", required: false, aliases: ["repair", "repair forecast"] },
  { key: "repairRemark", label: "Repair Remark", required: false, aliases: ["repair remark", "repair_remark"] },
  { key: "retreadForecast", label: "Retread (IDR)", required: false, aliases: ["retread", "retread forecast"] },
  { key: "retreadRemark", label: "Retread Remark", required: false, aliases: ["retread remark", "retread_remark"] },
  { key: "serviceForecast", label: "Service (IDR)", required: false, aliases: ["service", "service forecast"] },
  { key: "serviceRemark", label: "Service Remark", required: false, aliases: ["service remark", "service_remark"] },
  { key: "accessoriesAmountIdr", label: "Amount (IDR)", required: false, aliases: ["amount idr", "amount_idr", "accessories idr"] },
  { key: "accessoriesAmountUsd", label: "Amount (USD)", required: false, aliases: ["amount usd", "amount_usd", "accessories usd"] },
...
export function parseCsForecastNumber(
  value: string,
  defaultValue: number,
) {
